...
let config = {
  primary:
    "https://content.uplynk.com/044b9f180b4249f88b02231f13110239.m3u8" + (QUERY_PRIMARY ? QUERY_PRIMARY : ""),
  secondaries: [
...
function createPlayer(selector, muted, index) {
  var player = new THEOplayer.Player(document.querySelector(selector), {
    ...
    libraryLocation:
      "//cdn.myth.theoplayer.com/f60c5481-e021-4f44-b9b1-1704802ff495/",
    ui: {
      width: "100%",
      height: "100%"
    },
